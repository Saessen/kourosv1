...
{
    #[Route('/', name: 'formations_index', methods: ['GET', 'POST'])]
    public function index(FormationsRepository $formationsRepository, Request $request): Response
    {   
        // recherche 
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $formations= $formationsRepository->search(
